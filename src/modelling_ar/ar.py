...
def get_breathe_prior_from_1_day_model_o2sat_ecFEV1():
    prior = np.array([3.30017877e-02, 2.94332809e-02, 2.84614482e-02, 2.81412788e-02,
       2.80715428e-02, 2.82201463e-02, 2.85892890e-02, 2.91370387e-02,
       2.98440633e-02, 3.06870369e-02, 3.16515009e-02, 3.27659391e-02,
       3.40436812e-02, 3.54580906e-02, 3.69616283e-02, 3.84909562e-02,
       3.99707817e-02, 4.01369105e-02, 3.77586072e-02, 3.43664921e-02,
       3.14186539e-02, 2.94729070e-02, 2.79070486e-02, 2.67226722e-02,
       2.59757994e-02, 2.56031345e-02, 2.53547631e-02, 2.48108307e-02,
       2.35277866e-02, 2.19954118e-02, 1.98629847e-02, 1.72215473e-02,
       1.40814049e-02, 1.14758315e-02, 8.35226825e-03, 5.45547550e-03,
       2.82376684e-03, 1.15447994e-03, 4.89654330e-04, 3.83187888e-04,
       3.77857055e-04, 2.55912690e-04, 7.89846586e-05, 6.09149399e-06,
       4.48797604e-08])
    prior = prior / np.sum(prior)
    return prior

def get_breathe_prior_from_2_days_model_ecFEV1_ecFEF2575():
    prior = np.array([6.11640552e-03, 1.06277102e-02, 1.67953608e-02, 2.40280203e-02,
       2.81953570e-02, 3.08307897e-02, 3.31139141e-02, 3.49966946e-02,
       3.56556967e-02, 3.49566471e-02, 3.31038263e-02, 3.20199153e-02,
       3.21722512e-02, 3.31384393e-02, 3.44443241e-02, 3.59152936e-02,
       3.74083697e-02, 3.83917327e-02, 3.78846072e-02, 3.70470948e-02,
       3.65646442e-02, 3.49691951e-02, 3.36754074e-02, 3.24133419e-02,
       3.09303100e-02, 2.95958755e-02, 2.84330163e-02, 2.71876474e-02,
       2.55290796e-02, 2.33528993e-02, 2.07703567e-02, 1.79969619e-02,
       1.49841139e-02, 1.20675198e-02, 9.27738935e-03, 6.78022379e-03,
       4.42289991e-03, 2.12593694e-03, 6.34910446e-04, 3.17294432e-04,
       4.22426531e-04, 4.27418502e-04, 2.31645130e-04, 4.47277976e-05,
       2.30775204e-06])
    prior = prior / np.sum(prior)
    return prior
