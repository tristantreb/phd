...
def set_temporal_AR_params(AR, ar_change_cpt_suffix, ar_prior):
    ...
    elif ar_change_cpt_suffix == "_shape_factor_single_laplace_card14":
        Var_ar_change = DiscreteVariableNode(
            "AR change factor shape", 1, 14, 1, {"type": "uniform"}
        )
    elif ar_change_cpt_suffix == "_shape_factor_single_laplace_1.6":
        Var_ar_change = DiscreteVariableNode(
            "AR change factor shape", 1, 1, 1, {"type": "uniform"}
        )
    ...
    elif ar_change_cpt_suffix == "_shape_factor_single_laplace_card3":
        Var_ar_change = DiscreteVariableNode(
            "AR change factor shape", 1, 3, 1, {"type": "uniform"}
        )
    elif ar_change_cpt_suffix == "_shape_factor_single_laplace_card10":
        Var_ar_change = DiscreteVariableNode(
            "AR change factor shape", 1, 10, 1, {"type": "uniform"}
        )
    elif ar_change_cpt_suffix == "_shape_factor_single_laplace_0.5":
        Var_ar_change = DiscreteVariableNode(
            "AR change factor shape", 1, 1, 1, {"type": "uniform"}
        )
    elif ar_change_cpt_suffix == "_shape_factor_single_laplace_1.5":
        Var_ar_change = DiscreteVariableNode(
            "AR change factor shape", 1, 1, 1, {"type": "uniform"}
        )
    elif ar_change_cpt_suffix == "_shape_factor_single_laplace_card9":
        Var_ar_change = DiscreteVariableNode(
            "AR change factor shape", 1, 9, 1, {"type": "uniform"}
        )
    elif ar_change_cpt_suffix == "_shape_factor_main_tail_card23":
        Var_ar_change = DiscreteVariableNode(
            "AR change factor shape", 1, 23, 1, {"type": "uniform"}
        )
    ...
    elif ar_change_cpt_suffix == "_shape_factor_weight_card11":
        Var_ar_change = DiscreteVariableNode(
            "AR change factor shape", 1, 11, 1, {"type": "uniform"}
        )
    elif ar_change_cpt_suffix == "_shape_factor_grid_search_2":
        Var_ar_change = DiscreteVariableNode(
            "AR change factor shape", 1, 27, 1, {"type": "uniform"}
        )
    else:
...
def fev1_fef2575_long_model_noise_shared_healthy_vars(
    ...
    # Unused later on
    Var_ar_change = set_temporal_AR_params(
        AR, "_shape_factor_single_laplace_1.6", ar_prior
    )
