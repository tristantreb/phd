...
def partition_given_thresholds(series, thresholds, labels=False):
    """
    Partition a Panda Series into groups according to a given set of thresholds
    :param series: Panda Series of input data
    :param thresholds: list of floats corresponding to the wanted interval thresholds. Don't include the boundaries, e.g. 40.0 returns groups for: <40.0, >= 40.0
    :param labels: bool to return group labels (or not)
    :return: series where values is replaced with group label
    """
