...
\begin{figure}[!h]
    ...
    \centering
    \includegraphics[width=150mm]{Chapter1/Figs/o2_\F_with_exacerbated_labels.png}
...
\begin{figure}[!h]
    ...
    \centering
    \includegraphics[width=80mm]{Chapter1/Figs/\F_side_model_structure.png}
    \label{graph:\F_side}
\end{figure}
...
\begin{figure}[!h]
    ...
    \centering
    \includegraphics[width=50mm]{Chapter1/Figs/unblocked_\F_model_structure.png}
...
\begin{figure}[!h]
    ...
    \centering
    \includegraphics[width=80mm]{Chapter1/Figs/factor_healthy_\F_lung_damage.png}
...
\begin{figure}[!h]
    ...
    \centering
    \includegraphics[width=150mm]{Chapter1/Figs/factor_unblocked_\F_small_airway_blockage.png}
...
\begin{figure}[!h]
    ...
    \centering
    \includegraphics[width=50mm]{Chapter1/Figs/\F_noise_model.png}
...
% Lung tolerance
% PaO2, and therefore more subtly oxygen saturation, drops from its healthy baseline when the dominant part of the blood passes through unventilated lungs. 
...
% TODO: Add another justification for why not using PaO2.  Talk about the ventilation threshold and relationship between lung size and lung units.
...
% IMPORTANT: note that if we had PaO2, the line might reduce linearly
...
\begin{algorithmic}[1]
\Function{generateO2SatMeasurement}{$\vars{bin_{low}}, \vars{bin_{up}}, \vars{std_{gauss}}$}
...
% F6 therefore includes the uncertainty in the SpO2 drop due to i) alveoli that see airflow but that are damaged, ii) small airway blockage not captured by airway resistance, iii) underlying variability in F5. 
...
% - noise models
% - O2sat: surfaced signal related to compensatory mechanisms based on a non-linear, saturatied value. Would be super interesting to further refine it with PaO2 data.
